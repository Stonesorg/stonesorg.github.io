...
try {
  ...
  await page.goto(`${localSite.url}/tutors.html`, { waitUntil: 'domcontentloaded' });
  ...
  await mobilePage.goto(`${localSite.url}/booking.html?tutor=naomi-brooks`, { waitUntil: 'domcontentloaded' });
